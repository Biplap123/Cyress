describe('template spec', () => {
  it('passes', () => {
    ...
    // cy.xpath('//input[@placeholder="Article Titl"])[1]').type("katha056")
    cy.xpath('//input[@placeholder="Article Title"][1]').type(' jeevanjgjkatha1455593')
    cy.xpath('//input[@placeholder="What\'s this article about?"]').type('jeevan=katha2944921')
    cy.xpath('//textarea[@placeholder="Write your article (in markdown)"]').type('thisfgdfjcsjbcncnjsbcnfdhjhgygynjnscun')
